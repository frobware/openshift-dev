...
function print_env {
    set +u
    for var_name in KUBECONFIG CLUSTER_NAME AZURE_REGION BASE_DOMAIN BASE_DOMAIN_RESOURCE_GROUP PATH INFRA_ID RESOURCE_GROUP ACCOUNT_KEY OCP_ARCH VHD_URL PRINCIPAL_ID RESOURCE_GROUP_ID VHD_BLOB_URL STORAGE_ACCOUNT_ID AZ_ARCH PUBLIC_IP PUBLIC_IP_ROUTER BOOTSTRAP_URL BOOTSTRAP_IGNITION MASTER_IGNITION; do
